...
export class LeadsService {
  ...
  // }
  downloadZip(accountId: string, leadId: string, name: string): string {
    return `https://files.loancrm.org/files?accountId=${encodeURIComponent(accountId)}&leadId=${encodeURIComponent(leadId)}&name=${encodeURIComponent(name)}&downloadZip=true`;
  }
